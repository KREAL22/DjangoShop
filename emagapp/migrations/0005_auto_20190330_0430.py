# Generated by Django 2.1.7 on 2019-03-30 01:30
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('emagapp', '0004_auto_20190325_0433'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='cart',
            name='items',
            field=models.ManyToManyField(blank=True, to='emagapp.CartItem'),
        ),
        migrations.AddField(
            model_name='order',
            name='items',
            field=models.ManyToManyField(to='emagapp.Cart'),
        ),
        migrations.AddField(
            model_name='order',
            name='user',
