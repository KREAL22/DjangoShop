...
class OrderForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['phone'].help_text = 'Пожалуйста, укажите реальный номер телефона, по которому с вами можно связаться! '
        ...
        self.fields['date'].help_text = 'Доставка производится на следующий день после совершения заказа.'
